...
type TypedTransProps<
  Value,
  Components,
  Context extends string | undefined = undefined,
> = Omit<
  TransProps<string, never, never, Context>,
  'values' | 'ns' | 'i18nKey'
> &
  ({} extends Value
    ? {}
...
export function useAFFiNEI18N(): {
   ...
   * `{{name}}'s settings`
   */
  ['Workspace Settings with name'](options: { readonly name: string }): string;
  /**
   * `{{name}} is saved locally`
   */
  ['Workspace saved locally'](options: { readonly name: string }): string;
  /**
   * `Zoom in`
   */
  ['Zoom in'](): string;
   ...
   */
  ['com.affine.auth.page.sent.email.subtitle'](
    options: Readonly<{
      min: string;
      max: string;
    }>
   ...
   * `Please set a password of {{min}}-{{max}} characters with both letters and numbers to continue signing up with `
   */
  ['com.affine.auth.set.password.message'](
    options: Readonly<{
      min: string;
      max: string;
    }>
   ...
   */
  ['com.affine.payment.change-to'](options: { readonly to: string }): string;
  /**
   * `Include in FOSS`
   */
   ...
   */
  ['com.affine.payment.member-limit.description'](
    options: Readonly<{
      planName: string;
      quota: string;
    }>
   ...
   */
  ['com.affine.payment.member.description'](
    options: Readonly<{
      planName: string;
      memberLimit: string;
    }>
   ...
   */
  ['com.affine.payment.member.team.invite.notify.title'](
    options: Readonly<{
      successCount: string;
      failedCount: string;
    }>
   ...
   * `Last {{weekday}}`
   */
  ['com.affine.last-week'](options: { readonly weekday: string }): string;
  /**
   * `Next {{weekday}}`
   */
  ['com.affine.next-week'](options: { readonly weekday: string }): string;
  /**
   ...
   * `Rename to "{{name}}"`
   */
  ['com.affine.m.rename-to'](options: { readonly name: string }): string;
  /**
   * `Rename`
   */
   ...
   */
  ['com.affine.m.explorer.folder.new-tip-not-empty'](
    options: Readonly<{
      value: string;
      parent: string;
    }>
   ...
   * `Manage {{type}}(s)`
   */
  ['com.affine.m.selector.title'](options: { readonly type: string }): string;
  /**
   * `{{total}} item(s)`
   */
   ...
   * `Add {{count}} {{type}}(s)`
   */
  ['com.affine.m.selector.info-added'](
    options: Readonly<{
      count: string;
      type: string;
    }>
   ...
   * `Remove {{count}} {{type}}(s)`
   */
  ['com.affine.m.selector.info-removed'](
    options: Readonly<{
      count: string;
      type: string;
    }>
   ...
   */
  ['com.affine.m.selector.remove-warning.message'](
    options: Readonly<{
      type: string;
      where: string;
    }>
  ...
  /**
   * `[Action Required] Workspace sync paused`
   */
  ['com.affine.payment.sync-paused.owner.title'](): string;
  /**
   ...
   */
  ['com.affine.payment.sync-paused.member.title'](): string;
  /**
  ...
  return useMemo(() => createProxy(key => t.bind(null, key)), [t]);
}
function createComponent(i18nKey: string) {
  return props =>
    createElement(Trans, { i18nKey, shouldUnescape: true, ...props });
}
export const TypedTrans: {
  /**
   * `Go to <a>{{link}}</a> for learn more details about AFFiNE AI.`
   */
  ['com.affine.ai-onboarding.general.5.description']: ComponentType<
    TypedTransProps<
      {
   ...
   */
  ['com.affine.ai-onboarding.general.privacy']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        a: JSX.Element;
   ...
   */
  ['com.affine.auth.open.affine.prompt']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.auth.open.affine.open-doc-prompt']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.auth.sign.auth.code.message.password']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.auth.sign.add-selfhosted.description']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.auth.sign.message']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.auth.sign.sent.email.message.sent-tips']: ComponentType<
    TypedTransProps<
      {
        readonly email: string;
      },
   ...
   */
  ['com.affine.banner.content']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
  ...
  /**
      ...
      */
  ['com.affine.collection.toolbar.selected']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   */
  ['com.affine.collection.toolbar.selected_one']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   */
  ['com.affine.collection.toolbar.selected_other']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   * `<0>{{count}}</0> collection(s) selected`
   */
  ['com.affine.collection.toolbar.selected_others']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   */
  ['com.affine.delete-tags.confirm.description']: ComponentType<
    TypedTransProps<
      {
        readonly tag: string;
      },
   ...
   */
  ['com.affine.editCollection.rules.countTips']: ComponentType<
    TypedTransProps<
      Readonly<{
   ...
   */
  ['com.affine.editCollection.rules.countTips.more']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   */
  ['com.affine.editCollection.rules.countTips.one']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   * `Showing <1>{{count}}</1> docs.`
   */
  ['com.affine.editCollection.rules.countTips.zero']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   */
  ['com.affine.editCollection.rules.empty.noRules.tips']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.editCollection.rules.tips']: ComponentType<
    TypedTransProps<
      {
   ...
   */
  ['com.affine.history.confirm-restore-modal.free-plan-prompt.description']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.history.confirm-restore-modal.pro-plan-prompt.description']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
  ...
  /**
      ...
      */
  ['com.affine.page.toolbar.selected']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   */
  ['com.affine.page.toolbar.selected_one']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   */
  ['com.affine.page.toolbar.selected_other']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   * `<0>{{count}}</0> doc(s) selected`
   */
  ['com.affine.page.toolbar.selected_others']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   */
  ['com.affine.payment.billing-setting.ai.free-desc']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        a: JSX.Element;
   ...
   */
  ['com.affine.payment.billing-setting.believer.description']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        a: JSX.Element;
   ...
   */
  ['com.affine.payment.billing-setting.current-plan.description']: ComponentType<
    TypedTransProps<
      {
   ...
   */
  ['com.affine.payment.billing-setting.current-plan.description.lifetime']: ComponentType<
    TypedTransProps<
      {
        readonly planName: string;
      },
   ...
   */
  ['com.affine.payment.billing-setting.current-plan.description.monthly']: ComponentType<
    TypedTransProps<
      {
        readonly planName: string;
      },
   ...
   */
  ['com.affine.payment.billing-setting.current-plan.description.yearly']: ComponentType<
    TypedTransProps<
      {
        readonly planName: string;
      },
   ...
   */
  ['com.affine.payment.lifetime.caption-2']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        a: JSX.Element;
   ...
   */
  ['com.affine.payment.subtitle-active']: ComponentType<
    TypedTransProps<
      {
   ...
   */
  ['com.affine.payment.upgrade-success-page.support']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   * `If you have any questions, please contact our <1>customer support</1>.`
   */
  ['com.affine.payment.upgrade-success-page.team.text-2']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.rootAppSidebar.migration-data.clean-all.description']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        b: JSX.Element;
   ...
   */
  ['com.affine.rootAppSidebar.migration-data.help.description']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        b: JSX.Element;
   ...
   */
  ['com.affine.selectPage.empty.tips']: ComponentType<
    TypedTransProps<
      {
   ...
   */
  ['com.affine.open-in-app.card.subtitle']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.settings.editorSettings.general.spell-check.restart-hint']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.settings.suggestion-2']: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.settings.workspace.properties.delete-property-desc']: ComponentType<
    TypedTransProps<
      {
        readonly name: string;
      },
   ...
   * `<0>{{count}}</0> doc`
   */
  ['com.affine.settings.workspace.properties.doc']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   * `<0>{{count}}</0> docs`
   */
  ['com.affine.settings.workspace.properties.doc_others']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   */
  ['com.affine.settings.workspace.properties.header.subtitle']: ComponentType<
    TypedTransProps<
      {
        readonly name: string;
      },
  ...
  /**
      ...
      */
  ['com.affine.tag.toolbar.selected']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   */
  ['com.affine.tag.toolbar.selected_one']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   */
  ['com.affine.tag.toolbar.selected_other']: ComponentType<
    TypedTransProps<
      {
        readonly count: string | number | bigint;
      },
   ...
   * `<0>{{count}}</0> tag(s) selected`
   */
  ['com.affine.tag.toolbar.selected_others']: ComponentType<
    TypedTransProps<
      {
        readonly count: string;
      },
   ...
   */
  ['com.affine.workspaceDelete.description']: ComponentType<
    TypedTransProps<
      {
        readonly workspace: string;
      },
   ...
   */
  ['com.affine.workspaceDelete.description2']: ComponentType<
    TypedTransProps<
      {
        readonly workspace: string;
      },
   ...
   */
  recommendBrowser: ComponentType<
    TypedTransProps<
      Readonly<{}>,
      {
        ['1']: JSX.Element;
   ...
   */
  ['com.affine.upgrade-to-team-page.upgrade-confirm.description']: ComponentType<
    TypedTransProps<
      {
        readonly workspaceName: string;
      },
